...
/** @brief LovyanGFX device: ILI9341 panel + XPT2046 touch on VSPI (LOLIN32 pinout). */
...
/**
 * @brief LV_EVENT_CLICKED handler for the main button — increments click counter.
...
static void create_ui(void) {
    ...
    lv_label_set_text(title, "Przyklad od Inzyniera domu");
